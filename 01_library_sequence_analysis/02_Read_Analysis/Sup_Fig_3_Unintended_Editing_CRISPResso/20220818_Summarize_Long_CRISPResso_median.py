        ...
        try:
            ...
            for index, modtype in enumerate(modlist):
                for posind, pos in enumerate(nickcolumns):
                    ...
                    nicklist[index][posind] = modpercentage
                if totalreads == 0:
                    print('Reference:',totalreads)
                for posind, pos in enumerate(flapcolumns):
                    ...
                    flaplist[index][posind] = modpercentage
...
hdrmeanlist = ['hdrpbsmutationaverage','hdrnickmutation_1',
 'hdrnickmutation_2',
 'hdrnickmutation_3',
 'hdrnickmutation_4','hdrrttmutationaverage', 'hdrflapmutation_1',
 'hdrflapmutation_2',
 'hdrflapmutation_3',
 'hdrflapmutation_4','hdrflapmutation_5',
 'hdrflapmutation_6',
 'hdrflapmutation_7']

referencemeanlist = ['referencepbsmutationaverage','referencenickmutation_1',
 'referencenickmutation_2',
 'referencenickmutation_3',
 'referencenickmutation_4','referencerttmutationaverage', 'referenceflapmutation_1',
 'referenceflapmutation_2',
 'referenceflapmutation_3',
 'referenceflapmutation_4','referenceflapmutation_5',
 'referenceflapmutation_6',
 'referenceflapmutation_7']
for amptype in ['HDR','Reference']:
    if amptype == 'HDR':
        hdrmeanvalues = meandf[hdrmeanlist]
    if amptype == 'Reference':
        referencemeanvalues = meandf[referencemeanlist]
print(hdrmeanlist, hdrmeanvalues)
print(referencemeanlist, referencemeanvalues)

summarydf.to_csv('20220818_CRISPResso_long_summary_'+cwd+'.csv')

# mutationdict = {1:{'A':[1],'T':[2],'G':[4],'C':[8]}}
# mutationdict = {'A':[],'T':[],'G':[],'C':[]}

# for posind, pos in enumerate(flapcolumns):
#     print(pos)
#     bases = ['A','T','G','C']
#     posbase = pos.split('.')[0]
#     bases.remove(posbase)
#     for x in bases:
#         mutationdict[x].append(nulceotidepercentagedf.at[x,pos])
#     print(mutationdict)