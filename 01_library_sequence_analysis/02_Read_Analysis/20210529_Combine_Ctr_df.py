...
Ctr_1_df = pd.read_csv('20210529_04-NM-C1_analysisdf_focused.csv')
Ctr_2_df = pd.read_csv('20210529_05-NM-C2_analysisdf_focused.csv')
...
Ctr_df.to_csv('20210529_04-NM-CtrCombined_analysisdf_focused_full.csv')
...
Ctr_short_df.to_csv('20210529_04-NM-CtrCombined_analysisdf_focused.csv')
